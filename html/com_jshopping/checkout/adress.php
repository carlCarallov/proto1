...
<div id="comjshop">
    ...
    <div class="jshop address_block">
        ...
        ?>
        <form action = "<?php print $this->action ?>" method = "post" name = "loginForm" onsubmit = "return validateCheckoutAdressForm('<?php print $this->live_path ?>', this.name)" class = "form-horizontal" autocomplete="off" enctype="multipart/form-data" role="form">
            ...
            <div class = "jshop_register">
                ...
                <div class = "form-group">
                  ...
                  <div class = "col-sm-7">
                    <input type = "text" name = "email2" id = "email2" value = "<?php print $this->user->email ?>" class = "form-control" />
                  </div>
                </div>
                <?php } ?> 
            ...
            <div id = "div_delivery" class = "jshop_register" style = "padding-bottom:0px;<?php if (!$this->delivery_adress){ ?>display:none;<?php } ?>">
                ...
                <div class = "form-group">
                    ...
                    <div class = "col-sm-7">
                    <input type = "text" name = "d_city" id = "d_city" value = "<?php print $this->user->d_city ?>" class = "form-control" />
                    </div>
                </div>
                <?php } ?>
                ...
                <div class = "form-group">
                    ...
                    <div class = "col-sm-7">
                    <input type = "text" name = "d_state" id = "d_state" value = "<?php print $this->user->d_state ?>" class = "form-control" />
                    </div>
                </div>
                <?php } ?>
                ...
                <div class = "form-group">
                    ...
                    <div class = "col-sm-7">
                    <input type = "text" name = "d_ext_field_1" id = "d_ext_field_1" value = "<?php print $this->user->d_ext_field_1 ?>" class = "form-control" />
                    </div>
                </div>
                <?php } ?>
            ...
            <div class = "form-group box_button">
                <div class = "col-sm-5">
                    ...
                    <input type = "submit" name = "next" value = "<?php print _JSHOP_NEXT ?>" class = "btn btn-success" />
                </div>
            </div>
        </form>
    </div>
