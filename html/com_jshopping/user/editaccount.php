...
<div class="jshop editaccount_block" id="comjshop">
    ...
    <h1 id="edit_account_pre-text"><?php print _JSHOP_EDIT_DATA ?></h1>
    
    <form action = "<?php print $this->action ?>" method = "post" name = "loginForm" onsubmit = "return validateEditAccountForm('<?php print $this->live_path ?>', this.name)" class = "form-horizontal" enctype="multipart/form-data" role="form">
        ...
        <div class = "jshop_register">
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "f_name" id = "f_name" value = "<?php print $this->user->f_name ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "l_name" id = "l_name" value = "<?php print $this->user->l_name ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "m_name" id = "m_name" value = "<?php print $this->user->m_name ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "firma_name" id = "firma_name" value = "<?php print $this->user->firma_name ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group" id='tr_field_firma_code' <?php if ($config_fields['client_type']['display'] && $this->user->client_type!="2"){?>style="display:none;"<?php } ?>>
                <div class = "col-sm-5 name">
                    <?php print _JSHOP_FIRMA_CODE ?> <?php if ($config_fields['firma_code']['require']){?><span>*</span><?php } ?>
                </div>
                <div class = "col-sm-7">
                    <input type = "text" name = "firma_code" id = "firma_code" value = "<?php print $this->user->firma_code ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            <?php if ($config_fields['tax_number']['display']){?>
            <div class = "form-group" id='tr_field_tax_number' <?php if ($config_fields['client_type']['display'] && $this->user->client_type!="2"){?>style="display:none;"<?php } ?>>
                <div class = "col-sm-5 name">
                    <?php print _JSHOP_VAT_NUMBER ?> <?php if ($config_fields['tax_number']['require']){?><span>*</span><?php } ?>
                </div>
                <div class = "col-sm-7">
                    <input type = "text" name = "tax_number" id = "tax_number" value = "<?php print $this->user->tax_number ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "email" id = "email" value = "<?php print $this->user->email ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "home" id = "home" value = "<?php print $this->user->home ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "apartment" id = "apartment" value = "<?php print $this->user->apartment ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "street" id = "street" value = "<?php print $this->user->street ?>" class = "form-control" />
                    <?php if ($config_fields['street_nr']['display']){?>
                <input type="text" name="street_nr" id="street_nr" value="<?php print $this->user->street_nr?>" class="form-control" />
                <?php }?>
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "zip" id = "zip" value = "<?php print $this->user->zip ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "city" id = "city" value = "<?php print $this->user->city ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "state" id = "state" value = "<?php print $this->user->state ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "phone" id = "phone" value = "<?php print $this->user->phone ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "mobil_phone" id = "mobil_phone" value = "<?php print $this->user->mobil_phone ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "fax" id = "fax" value = "<?php print $this->user->fax ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "ext_field_1" id = "ext_field_1" value = "<?php print $this->user->ext_field_1 ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "ext_field_2" id = "ext_field_2" value = "<?php print $this->user->ext_field_2 ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "ext_field_3" id = "ext_field_3" value = "<?php print $this->user->ext_field_3 ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "password" name = "password_2" id = "password_2" value = "" class = "form-control" />
                </div>
            </div>
            <?php } ?>
        ...
        <div class = "form-group other_delivery_adress">
            <div class = "col-sm-5 name">
                <?php print _JSHOP_DELIVERY_ADRESS ?>
            </div>
            <div class = "col-sm-7">
                <input type = "radio" name = "delivery_adress" id = "delivery_adress_1" value = "0" <?php if (!$this->delivery_adress) {?> checked = "checked" <?php } ?> onclick = "jQuery('#div_delivery').hide()" class="form-control"/>
                <label for = "delivery_adress_1"><?php print _JSHOP_NO ?></label>
                <input type = "radio" name = "delivery_adress" id = "delivery_adress_2" value = "1" <?php if ($this->delivery_adress) {?> checked = "checked" <?php } ?> onclick = "jQuery('#div_delivery').show()" class="form-control"/>
        ...
        <div id = "div_delivery" class = "jshop_register" style = "padding-bottom:0px;<?php if (!$this->delivery_adress){ ?>display:none;<?php } ?>" >
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_f_name" id = "d_f_name" value = "<?php print $this->user->d_f_name ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_l_name" id = "d_l_name" value = "<?php print $this->user->d_l_name ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_m_name" id = "d_m_name" value = "<?php print $this->user->d_m_name ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_email" id = "d_email" value = "<?php print $this->user->d_email ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_home" id = "d_home" value = "<?php print $this->user->d_home ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_apartment" id = "d_apartment" value = "<?php print $this->user->d_apartment ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>        
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_street" id = "d_street" value = "<?php print $this->user->d_street ?>" class = "form-control" />
                    <?php if ($config_fields['d_street_nr']['display']){?>
                        <input type="text" name="d_street_nr" id="d_street_nr" value="<?php print $this->user->d_street_nr?>" class="form-control" />
                    <?php }?>
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_zip" id = "d_zip" value = "<?php print $this->user->d_zip ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_phone" id = "d_phone" value = "<?php print $this->user->d_phone ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
            ...
            <div class = "form-group">
                ...
                <div class = "col-sm-7">
                    <input type = "text" name = "d_mobil_phone" id = "d_mobil_phone" value = "<?php print $this->user->d_mobil_phone ?>" class = "form-control" />
                </div>
            </div>
            <?php } ?>
        ...
        <div class = "form-group box_button">
            <div class = "col-sm-5">
                ...
                <input type = "button" name = "next" value = "<?php print _JSHOP_SAVE ?>" class = "btn btn-success button" />
            </div>
        </div>
    </form>
</div>    