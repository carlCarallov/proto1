...
<div class="profile-edit<?php echo $this->pageclass_sfx?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<?php if ($field->fieldname == 'password1') : ?>
								<?php // Disables autocomplete ?> <input type="password" style="display:none" class="form-control">
							<?php endif; ?>
							<?php echo $field->input; ?>
						</div>
					</div>
	...
	<?php endif; ?>
		...
		<div class="form-group">
			<div class="col-sm-5">
				<button type="submit" class="btn btn-success validate"><span><?php echo JText::_('JSUBMIT'); ?></span></button>
