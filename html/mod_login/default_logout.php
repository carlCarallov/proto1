...
<?php endif; ?>
	<div class=" logout-button" >
		<input type="submit" name="Submit"  value="<?php echo JText::_('JLOGOUT'); ?> " class="btn btn-warning" />
		<input type="hidden" name="option" value="com_users" />
		<input type="hidden" name="task" value="user.logout" />
		<input type="hidden" name="return" value="<?php echo $return; ?>" class="btn btn-warning/>
